...
def parse_args(argv: Iterable[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--node-root", default="data/kg/nodes", help="Local directory containing copied disease.parquet and tissue.parquet inputs for endpoint anti-join validation.")
    parser.add_argument("--cache-dir", default="artifacts/cache/disease-tissue-context", help="Pipeline-local source download cache directory.")
